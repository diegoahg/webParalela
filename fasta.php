				...
				<div class="container">
					<div class="row">
						...
						<div class="col-xs-10 col-sm-10 col-md-11 projectTitle">
							<h1>Image project</h1>
							<p>In Women / November 24</p>
							<ul class="breadcrumb visible-md visible-lg">
								<li><a href="index.html">Home</a></li>
								<li><a href="portfolio-masonery.html">Portfolio</a></li>
								<li><a href="portfolio-project-image.html">Single project</a></li>
								<li class="active">Image project</li>
							</ul>
						</div>
					</div>
				</div>
			...
			<section id="content" class="mt30">
						...
						<div class="col-md-4">
							<div class="row">
								<div class="col-md-12 col-sm-4">
									<h2>Another successful project </h2>
								...
								<div class="col-md-12 col-sm-4">
									<div id="shareme" data-url="http://little-neko.com" data-text="Check out SEATTLE, a great Bootstrap 3 One page template"> </div>
								</div>
							</div>
						</div>
					</div>
				...
				<section id="projects">
					<div class="container mt15">
						<div class="row">
							<div class="col-md-12">
								<h2>Other project in the same category</h2>
							</div>
						</div>
						<div class="row">
					...
					<section class="pt30 pb30 mb15">
						<div class="container">
							<div class="row">
								<div class="col-md-12">
									<div class="ctaBox ctaBox2Cols color1">
										...
										<div class="ctaBoxBtn">
											<a class="btn btn-lg btn-primary" title="" href="#" target="blank">

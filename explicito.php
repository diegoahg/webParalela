		...
		<section id="portfolio">
									...
									<div class="ctaBox ctaBox2Cols color2">
										<div class="col-lg-12">
											<form method="post" action="controlador.php" id="form-pbe" role="form" enctype="multipart/form-data">
												...
												<div class="col-lg-3">
													<div class="form-group">
														<label for="distribucion">Patrón</label>
														<input type="text" class="form-control" name="patron" id="patron" placeholder="">
													</div>
												</div>
												<div class="col-lg-3">
													<div class="form-group">
												...
												<div class="col-lg-3">
													<div class="form-group">
														<input type="hidden" class="form-control" name="size" value="81" id="size" placeholder="">
													</div>
												</div>
												<div class="row">
													<div class="col-lg-12">
			...
			<section id="content" class="mt30">
				<div class="container">
					<div class="row">
						<div class="col-md-8">
							<img src="images/portfolio/explicita.jpg" alt="SEATTLE premium website template" class="img-responsive mb30"/>
						</div>
						<div class="col-md-4">
							<div class="row">
								<div class="col-md-12 col-sm-4">
									<h1> Búsqueda Explicita de Patrones</h1>

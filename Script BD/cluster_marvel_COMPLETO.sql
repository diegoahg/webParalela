...
--
-- Servidor: localhost
-- Tiempo de generación: 02-07-2015 a las 14:15:59
...
--
CREATE DATABASE IF NOT EXISTS `cluster_marvel` DEFAULT CHARACTER SET utf8 COLLATE utf8_spanish_ci;
USE `cluster_marvel`;
...
--
-- Creación: 30-06-2015 a las 16:41:51
--

DROP TABLE IF EXISTS `historial_fasta`;
...
--
-- Creación: 30-06-2015 a las 19:58:21
--

DROP TABLE IF EXISTS `historial_percolacion`;
...
--
-- Creación: 30-06-2015 a las 16:58:42
--

DROP TABLE IF EXISTS `historial_torah`;
...
--
-- Creación: 25-06-2015 a las 14:02:09
--

DROP TABLE IF EXISTS `tipo_arbol`;
...
--
-- Creación: 25-06-2015 a las 13:54:07
--
...
--
-- Creación: 25-06-2015 a las 14:03:54
--
...
--
-- Creación: 23-06-2015 a las 18:16:52
--
